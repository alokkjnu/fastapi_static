...
class FastAPI(Starlette):
    def __init__(
        ...
        *,
        ...
        title: str = " ",
        description: str = "<img src='https://lh3.googleusercontent.com/LuRAAUdVV0GswBjBXYv3eXePvbBgn1prSIFRH766hY4v9zeHqhIhQHh1WEeSZOUI4pjXDw=s170' width='200' height='70'>" +"\n\n\n" +" New generation payment technology",
        version: str = "",
